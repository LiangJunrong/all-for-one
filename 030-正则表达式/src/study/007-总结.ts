  ...
  return `
    ...
    <html lang="zh-CN">
      ...
      <body style="background: #fff !important">
        ...
        <li><section style="margin-top: 5px; margin-bottom: 5px; line-height: 26px; text-align: left; color: rgb(1,1,1); font-weight: 500;">学习 + 练习地址：https://regexone.com/</section></li><li><section style="margin-top: 5px; margin-bottom: 5px; line-height: 26px; text-align: left; color: rgb(1,1,1); font-weight: 500;">测试地址：https://regexr.com/</section></li></ol>
        <p data-tool="mdnice编辑器" style="font-size: 16px; padding-bottom: 8px; margin: 0; padding-top: 1em; color: rgb(74,74,74); line-height: 1.75em;">中文平台可以找找</p>
