...
const fs = require("fs");
// 自动生成目录
const buildSimpleDirectory = vscode.commands.registerTextEditorCommand('jsliang.buildSimpleDirectory', (textEditor, edit) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (lineText.includes('##')) {
            ...
            if (lineText.includes('####')) { // 如果当前行是四级标题
                ...
                // 追加目录
                category += `| &emsp;&emsp;${twoCategory}.${threeCategory}.${fourCategory} ${categoryName} |\r\n`;
            }
                ...
                // 追加目录
                category += `| &emsp;${twoCategory}.${threeCategory} ${categoryName} |\r\n`;
            }
                ...
                // 追加目录
                category += `| ${chineseHash[twoCategory]} ${categoryName} |\r\n`;
            }
        }
    }
    category += '<!-- 目录结束 -->\r\n\r\n';
...
module.exports = (context) => {
    context.subscriptions.push(buildSimpleDirectory);
};
//# sourceMappingURL=buildSimpleDirectory.js.map